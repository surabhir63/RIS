...
if 'Power (dBm)' not in df_predictions.columns:
...
##df_filtered = df_predictions[df_predictions["Power (dBm)"] > -250]

# ✅ Create pivot table for heatmap
heatmap_data = df_predictions.pivot_table(index="Y", columns="X", values="Power (dBm)", aggfunc="mean")
...
plt.title("Power Distribution Across 50 Receiver Positions", fontsize=14, fontweight="bold")

# ✅ Save the plot
output_file = "power_distribution_heatmap_50_final.png"  # File name for the saved plot
