...
df_calltest = pd.read_csv("Without_RIS_optimization_data_sin50.csv")
...
plt.title("Power Distribution Across Common Receiver Positions without RIS", fontsize=12, fontweight="bold")

# ✅ Save the plot
output_file = "power_distribution_heatmap_wo_optimization_RIS.png"
